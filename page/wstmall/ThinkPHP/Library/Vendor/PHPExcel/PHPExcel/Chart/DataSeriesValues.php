...
class PHPExcel_Chart_DataSeriesValues
{
	...
	/**
	 * Get Series Model Source (formula)
	 *
	 * @return	string
	 */
	...
	/**
	 * Set Series Model Source (formula)
	 *
	...
	/**
	 * Identify if the Model Series is a multi-level or a simple series
	 *
	 * @return	boolean
	 */
	...
	/**
	 * Return the level count of a multi-level Model Series
	 *
	 * @return	boolean
	 */
	...
	/**
	 * Get the first Series Model value
	 *
	 * @return	mixed
	 */
