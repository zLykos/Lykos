	...
	showQuickPop = function(type){
		...
		if(type !== prevPopType){
			...
			if(fn && fn.msgtype==1){
				...
				fn.content = "<div class='ibar_plugin_loading' style=''><images src='"+WST.DOMAIN +"/Apps/Home/View/"+WST.WST_STYLE +"/images/loading.gif' width='20'/>数据加载中...</div>";
							...
							for(var goodsId in pkg.goods){
								...
								html.push(  "<div class='cart_item'>" +
											"<div class='cart_item_pic'>" +
												"<a href='"+url+"'><images src='"+WST.DOMAIN +"/"+goods.goodsThums+"'  style='margin-left:28px;'/></a>" +
											"</div>" +
											"<div class='cart_item_desc'>" +
