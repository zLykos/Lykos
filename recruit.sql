...
CREATE TABLE `mq_enter_register` (
  ...
  `user_rand` int(6) DEFAULT NULL COMMENT '邮箱验证码',
...
CREATE TABLE `mq_user_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id(基本信息)',
  `user_id` int(11) DEFAULT NULL COMMENT '用户Id',
...
-- ----------------------------
INSERT INTO `mq_user_message` VALUES ('27', null, '千万4去武器', '男', '0', '4千万(づ￣3￣)づ╭❤～钱3 ', '0', '(づ￣3￣)づ╭❤～5千万q', '硕士', '亲4去w', '10年以上');
INSERT INTO `mq_user_message` VALUES ('28', null, '', '', null, '', null, '', '', '', '');
...
CREATE TABLE `mq_user_register` (
  ...
  `user_rand` int(6) DEFAULT NULL COMMENT '用户验证码',
...
-- ----------------------------
INSERT INTO `mq_user_register` VALUES ('1', '2147483647', '', '0678ca2eae02d542cc931e81b74de122', '5285', '127.0.0.1', '1509677039');
...
CREATE TABLE `mq_user_resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自我评价id',
  `user_id` int(11) DEFAULT NULL COMMENT '用户ID',
...
CREATE TABLE `mq_user_study` (
  ...
  `stu_major` varchar(32) CHARACTER SET utf8 DEFAULT '' COMMENT '就读专业',
