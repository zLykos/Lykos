$("#getPhoneVerify").click(function(){
	...
	if ($("#userPhone").val() == '') {
		...
		if(WST.SMS_VERFY=='1'){
			...
			html.push('<images style="vertical-align:middle;cursor:pointer;height:39px;" class="verifyImg" src="'+WST.DOMAIN+'/Apps/Home/View/'+WST.WST_STYLE+'/images/clickForVerify.png" title="刷新验证码" onclick="javascript:getVerify()"/>');
