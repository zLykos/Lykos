                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo U('Admin/Reports/toStatUserLogin');?>" target='pageContent' >会员登录统计</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <?php if(in_array('cxgl_00',$WST_STAFF['grant'])){ ?>
                        <li class="treeview">
                            <a href="#">
                                <span>促销管理</span>
                            </a>
                            <ul class="treeview-menu">
                            	<?php if(in_array('cxgl_01',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Admin/Groups/queryGroupGoods');?>" target='pageContent'>团购管理</a></li>
					            <?php } ?>
					            <?php if(in_array('cxgl_02',$WST_STAFF['grant'])){ ?>
                            	<li><a href="<?php echo U('Admin/Panics/queryPanicGoods');?>" target='pageContent' >抢购管理</a></li>
                            	<?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
					            ...
					            <?php } ?>
                                <?php if(in_array('fggl_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Admin/Styles/index');?>" target='pageContent'>风格管理</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo U('Admin/WxMenus/index');?>" target='pageContent' >自定义菜单</a></li>
                                <li><a href="<?php echo U('Admin/WxUsers/index');?>" target='pageContent' >用户管理</a></li>
                                <li><a href="<?php echo U('Admin/WxPassiveReply/text');?>" target='pageContent' >被动回复文本消息</a></li>
                                <li><a href="<?php echo U('Admin/WxPassiveReply/news');?>" target='pageContent' >被动回复图文消息</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
