function uploadAblumInit() {
        var $wrap = $('#uploader'),
            ...
            isSupportBase64 = ( function() {
                ...
                data.src = "data:images/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";
                return support;
            } )(),
        ...
        uploader = WebUploader.create({
            ...
            fileVal:'Filedata',
             accept: {
                 ...
                 mimeTypes: 'images/jpg,images/jpeg,images/png,images/gif'
             },
        ...
        uploader.onUploadSuccess=function(file,response) {
            oRet=response._raw;
            var obj = eval("(" + oRet + ")");
            $('#'+file.id).append('<input type="hidden" class="gallery-images" iv="'+obj.Filedata.savepath + obj.Filedata.savethumbname+'" v="' +obj.Filedata.savepath + obj.Filedata.savename+'"/>');
        }
