	...
	class SmartTemplateDebugger
	{
		...
		*/
		function start ( $vars )
		{
			...
			echo '<li><a href="#data_code">Model</a></li>';
			echo '</b></font><hr>';
			...
			// Print Model
			echo '<a name="data_code"><br><br><font face="Arial" Size="3"><b>Model:</b>&nbsp;[<a href="javascript:void(\'\');" onclick="toggleVisibility(document.getElementById(MoModel, this); return false">Hide Ouptut</a>]</font><br>';
			echo '<table border="0" cellpadding="4" cellspacing="1" width="100%" bgcolor="#C6D3EF"><tr><td bgcolor="#F0F0F0"><pre id="DatModeltyle="display:block">';
