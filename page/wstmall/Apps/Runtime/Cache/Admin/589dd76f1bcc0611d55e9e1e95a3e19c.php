...
<html lang="zh-cn">
   <head>
      ...
      <link href="/MVC/wstmall/Public/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
      <link href="/MVC/wstmall/Apps/Admin/View/css/AdminLTE.css" rel="stylesheet" type="text/css" />
      <link href="/MVC/wstmall/Apps/Admin/View/css/upload.css" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" type="text/css" href="/MVC/wstmall/Public/plugins/webuploader/webuploader.css" />
      <!--[if lt IE 9]>
      <script src="/MVC/wstmall/Public/js/html5shiv.min.js"></script>
      <script src="/MVC/wstmall/Public/js/respond.min.js"></script>
      <![endif]-->
      <script src="/MVC/wstmall/Public/js/jquery.min.js"></script>
      <script src="/MVC/wstmall/Public/plugins/bootstrap/js/bootstrap.min.js"></script>
      <script src="/MVC/wstmall/Public/js/common.js"></script>
      <script src="/MVC/wstmall/Public/plugins/plugins/plugins.js"></script>
      <script src="/MVC/wstmall/Public/plugins/formValidator/formValidator-4.1.3.js"></script>
      <script src="/MVC/wstmall/Public/plugins/kindeditor/kindeditor.js"></script>
      <script src="/MVC/wstmall/Public/plugins/kindeditor/lang/zh-CN.js"></script>
      <script type="text/javascript" src="http://webapi.amap.com/maps?v=1.3&key=37f0869604ca86505487639427d52bf6"></script>
      <script type="text/javascript" src="/MVC/wstmall/Apps/Admin/View/js/upload.js"></script>
      <script type="text/javascript" src="/MVC/wstmall/Public/plugins/webuploader/webuploader.js"></script>
       ...
       <form name="myform" method="post" id="myform" autocomplete="off">
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           ...
           <tr style="height:80px;">
             ...
             <td>
	             ...
	             <div id="preview_Filedata">
	             	<img id='preview' src='/MVC/wstmall/<?php echo ($object["shopImg"]); ?>' ref='/MVC/wstmall/<?php echo ($object["shopImg"]); ?>' <?php if($object['shopImg'] =='' ): ?>style='display:none'<?php else: ?>style='width:152px;height:152px;max-width:152px;'<?php endif; ?>/>
	             </div>
             </td>
           </tr>
           <tr>
           ...
           <tr>
             ...
             <td>
             <label>
             <input type='radio' name='isDistributAll' value='0' <?php if($object['isDistributAll'] ==0 ): ?>checked<?php endif; ?> />区域配送&nbsp;&nbsp;
             </label>
             <label>
             <input type='radio' name='isDistributAll' value='1' <?php if($object['isDistributAll'] ==1 ): ?>checked<?php endif; ?> />全国配送
             </label>
             </td>
           </tr>
